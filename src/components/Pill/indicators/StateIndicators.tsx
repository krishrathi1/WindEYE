...
export function TimerMiniProgress({ progress, width, height }: TimerMiniProgressProps) {
  ...
  return (
    <motion.svg
      ...
      style={{
        // Absolutely-positioned children anchor to the pill's *padding box*, which
        // sits 1px inside its border — that offset made the whole ring sit 1px
        // down-right of the pill (gap on top/left, tight on bottom/right).
        // Anchor at -1,-1 so the ring is centered on the pill's true outer edge.
        left: -1,
        top: -1,
        width,
        height,
