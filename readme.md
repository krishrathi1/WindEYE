<div align="center">
  <img src="public/pillar.svg" alt="WINDEYE — Dynamic Island for Windows logo" width="110" height="110">

  <h1>WINDEYE — Dynamic Island for Windows</h1>
...
**WINDEYE** brings Apple's **Dynamic Island** experience to **Windows**. It's a borderless, transparent,
...
> **media + notification widget for Windows**? That's WINDEYE.
...
- **`WINDEYE_x.y.z_x64-setup.exe`** — recommended installer (NSIS)
- **`WINDEYE_x.y.z_x64_en-US.msi`** — MSI installer (managed/enterprise installs)
...
<div align="center">
  <img src="docs/screenshot-media.png" alt="WINDEYE media controls" width="420">
  <img src="docs/screenshot-ai.png" alt="WINDEYE Prism AI" width="420">
</div>
-->
...
If the key is missing, Prism shows: *"GROQ_API_KEY is not set. Set it before building or running WINDEYE."*
